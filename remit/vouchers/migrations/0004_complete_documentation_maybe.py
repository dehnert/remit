...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Voucher.mailing_address'
        # (to signature: django.db.models.fields.TextField(blank=True))
        db.alter_column('vouchers_voucher', 'mailing_address', orm['vouchers.voucher:mailing_address'])
        
        # Changing field 'Voucher.documentation'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['vouchers.Documentation'], null=True, blank=True))
        db.alter_column('vouchers_voucher', 'documentation_id', orm['vouchers.voucher:documentation'])
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Voucher.documentation'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['vouchers.Documentation'], null=True))
        db.alter_column('vouchers_voucher', 'documentation_id', orm['vouchers.voucher:documentation'])
