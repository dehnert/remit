...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('vouchers_documentation', (
            ('id', orm['vouchers.documentation:id']),
            ('backing_file', orm['vouchers.documentation:backing_file']),
            ('label', orm['vouchers.documentation:label']),
        ))
        db.send_create_signal('vouchers', ['Documentation'])
        
        # Adding field 'Voucher.documentation'
        db.add_column('vouchers_voucher', 'documentation', orm['vouchers.voucher:documentation'])
        
        # Adding field 'ReimbursementRequest.documentation'
        db.add_column('vouchers_reimbursementrequest', 'documentation', orm['vouchers.reimbursementrequest:documentation'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('vouchers_documentation')
        
        # Deleting field 'Voucher.documentation'
        db.delete_column('vouchers_voucher', 'documentation_id')
        
        # Deleting field 'ReimbursementRequest.documentation'
        db.delete_column('vouchers_reimbursementrequest', 'documentation_id')
