...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Documentation.submitter'
        # (to signature: django.db.models.fields.CharField(max_length=30, null=True))
        db.alter_column('vouchers_documentation', 'submitter', orm['vouchers.documentation:submitter'])
        
        # Changing field 'ReimbursementRequest.submitter'
        # (to signature: django.db.models.fields.CharField(max_length=30))
        db.alter_column('vouchers_reimbursementrequest', 'submitter', orm['vouchers.reimbursementrequest:submitter'])
